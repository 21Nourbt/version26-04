        ...
        <div className="relative  h-[75vh] overflow-hidden shadow-2xl">
          ...
          <div className="absolute inset-0 bg-black/60 flex flex-col justify-between px-6 py-10 md:py-20">
            <div className="text-center">
              ...
              <Button className="bg-black hover:bg-lime-400 transition-colors duration-200 text-white px-8 py-3 rounded-xl shadow-lg"  type="button"
          onClick={() => {
             
            if (idUser) {
              router.push('/dashboard1/reserveMeetingroom')
            } else {
              router.push('/login');
            }
          }}>
